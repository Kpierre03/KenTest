...
import com.example.ken.kendemo17.adapter.ViewFragmentStateAdapter;
...
public class AdvanceViewPagerActivity extends AppCompatActivity {
    ...
    @BindView(R.id.activity_adavance_view_pager_tablayout)TabLayout tabLayout;

    @BindView(R.id.activity_advance_view_pager)ViewPager viewPager;
